...
// 			$(window).resize(function(){   $("#list2").setGridWidth($(window).width());});
	...
	function pageInit(){
		...
		jQuery("#list2").jqGrid(
				{
					url : '/LuhangComparePrice/QunaerPriceCompare/display7C8503 ',//组件创建完成之后请求数据的url
				...
				colNames : ['日期' ,'航班号' ,'网站平台', '7C8503最低价', '大韩航空KE839最低价','东航MU2018最低价'],

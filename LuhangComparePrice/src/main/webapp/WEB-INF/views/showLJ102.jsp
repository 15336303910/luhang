...
// 			$(window).resize(function(){   $("#list2").setGridWidth($(window).width());});
	...
	function pageInit(){
		...
		jQuery("#list2").jqGrid(
				{
					url : '/LuhangComparePrice/QunaerPriceCompare/displayLJ102 ',//组件创建完成之后请求数据的url
				...
				colNames : ['日期' ,'航班号' ,'网站平台', 'LJ102最低价', '春秋航空9C8569最低价','吉祥航空HO1375最低价'],

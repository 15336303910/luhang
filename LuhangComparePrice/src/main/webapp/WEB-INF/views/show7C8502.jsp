...
// 			$(window).resize(function(){   $("#list2").setGridWidth($(window).width());});
	...
	function pageInit(){
		...
		jQuery("#list2").jqGrid(
				{
					url : '/LuhangComparePrice/QunaerPriceCompare/display7C8502 ',//组件创建完成之后请求数据的url
				...
				colNames : ['日期' ,'航班号' ,'网站平台', '7C8502最低价', '东航MU2017最低价','韩亚航空OZ310最低价'],

...
// 			$(window).resize(function(){   $("#list2").setGridWidth($(window).width());});
	...
	function pageInit(){
		...
		jQuery("#list2").jqGrid(
				{
					url : 'http://localhost:8080/LuhangComparePrice/QunaerPriceCompare/display7C8501 ',//组件创建完成之后请求数据的url
				...
				colNames : ['序号','日期' ,'航班号' ,'网站平台', '7C8501最低价', '大韩KE840最低价','国航OZ310最低价'],
				colModel : [ //jqGrid每一列的配置信息。包括名字，索引，宽度,对齐方式.....
					          
						         {name : 'id',index : 'id',width : 100,align : "center"}, 
					            {name : 'date',index : 'date',formatter:"date",formatoptions: {srcformat:'Y-m-d H:i:s',newformat:'Y-m-d'},width : 100,align : "center"}, 
					          //{name : 'date',index : 'date',width : 100,align : "center"}, 
					          {name : 'flight_num',index : 'flight_num',width : 100,align : "center"}, 
					             {name : 'platform_web',index : 'platform_web',width : 100,align : "center"}, 
					             {name : 'sameairline_opp',index : 'sameairline_opp',width : 100,align : "center"}, 
					             {name : 'diffairline_opp1',index : 'diffairline_opp1',width : 100,align : "center"}, 
					             {name : 'diffairline_opp2',index : 'diffairline_opp2',width : 100,align : "center"}

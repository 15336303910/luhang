...
public class RoutingSearch {
	...
	public RoutingSearch(String data, String currency, int adultPrice, int adultTax, int childPrice, int childTax,
			int nationalityType, String nationality, String suitAge, int priceType, int applyType, int adultTaxType,
			int childTaxType, int ticketTimeLimit, Rule rule, ArrayList<AirlineInfo> fromSegment,
	...
	public String toString() {
		return "Routing [data=" + data + ", currency=" + currency + ", adultPrice=" + adultPrice + ", adultTax="
				...
				+ ", ticketTimeLimit=" + ticketTimeLimit + ", rule=" + rule + ", fromSegment=" + fromSegment
				+ ", retSegment=" + retSegment + ", combineIndexs=" + combineIndexs + ", tag=" + tag + "]";
	}
	@Override
	public int hashCode() {
		final int prime = 31;
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		RoutingSearch other = (RoutingSearch) obj;
	...
	/******
	 * 对从数据库进行search操作取出的一条数据进行封装，封装成一个RoutingSearch类
	 * @param routingRecord
	 * @return
	 */
	public void formatSearchRoutingData(RoutingRecord routingRecord,Rule rule,ArrayList<AirlineInfo> airlineInfoFrom,ArrayList<AirlineInfo> airlineInfoBack,ArrayList<Integer>combineIndexs){
		...
		/*	RoutingSearch routing =new RoutingSearch();

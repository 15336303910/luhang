package com.luhang.util.IPutil;
...
public class IPWhiteUtil {
    ...
    public static void main(String[] args) {
        ...
        String ipWhite = "192.168.1.1;" +                 //设置单个IP的白名单
                          "192.168.2.*;" +                 //设置ip通配符,对一个ip段进行匹配
                          "192.168.3.17-192.168.3.38";     //设置一个IP范围
        boolean flag = IPWhiteUtil.checkLoginIP("192.168.2.2",ipWhite);
        boolean flag2 = IPWhiteUtil.checkLoginIP("192.168.1.2",ipWhite);
        boolean flag3 = IPWhiteUtil.checkLoginIP("192.168.3.16",ipWhite);
        boolean flag4 = IPWhiteUtil.checkLoginIP("192.168.3.19",ipWhite);
